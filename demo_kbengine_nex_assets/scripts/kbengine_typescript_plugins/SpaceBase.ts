/*
	...
	Please inherit this module, such as: (class Space extends SpaceBase)
	tools = kbcmd
*/
...
import { EntityBaseEntityCall_SpaceBase, EntityCellEntityCall_SpaceBase } from './EntityCallSpaceBase';

// defined in */scripts/entity_defs/Space.def
// Please inherit and implement "class Space extends SpaceBase"
export abstract class SpaceBase extends Entity{
	public baseEntityCall:EntityBaseEntityCall_SpaceBase | null = null;
	public cellEntityCall:EntityCellEntityCall_SpaceBase | null = null;
	...
	public override onRemoteMethodCall(stream:MemoryStream){
		let sm:ScriptModule = EntityDef.moduledefs["Space"];

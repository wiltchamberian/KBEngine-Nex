/*
	...
	Please inherit this module, such as: (class Spaces extends SpacesBase)
	tools = kbcmd
*/
...
import { EntityBaseEntityCall_SpacesBase, EntityCellEntityCall_SpacesBase } from './EntityCallSpacesBase';

// defined in */scripts/entity_defs/Spaces.def
// Please inherit and implement "class Spaces extends SpacesBase"
export abstract class SpacesBase extends Entity{
	public baseEntityCall:EntityBaseEntityCall_SpacesBase | null = null;
	public cellEntityCall:EntityCellEntityCall_SpacesBase | null = null;
	...
	public override onRemoteMethodCall(stream:MemoryStream){
		let sm:ScriptModule = EntityDef.moduledefs["Spaces"];

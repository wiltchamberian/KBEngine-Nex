/*
	...
	Please inherit this module, such as: (class SpawnPoint extends SpawnPointBase)
	tools = kbcmd
*/
...
import { EntityBaseEntityCall_SpawnPointBase, EntityCellEntityCall_SpawnPointBase } from './EntityCallSpawnPointBase';

// defined in */scripts/entity_defs/SpawnPoint.def
// Please inherit and implement "class SpawnPoint extends SpawnPointBase"
export abstract class SpawnPointBase extends Entity{
	public baseEntityCall:EntityBaseEntityCall_SpawnPointBase | null = null;
	public cellEntityCall:EntityCellEntityCall_SpawnPointBase | null = null;
	...
	public override onRemoteMethodCall(stream:MemoryStream){
		let sm:ScriptModule = EntityDef.moduledefs["SpawnPoint"];

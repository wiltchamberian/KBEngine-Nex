/*
	...
	Please inherit this module, such as: (class TestNoBase extends TestNoBaseBase)
	tools = kbcmd
*/
...
import { EntityBaseEntityCall_TestNoBaseBase, EntityCellEntityCall_TestNoBaseBase } from './EntityCallTestNoBaseBase';

// defined in */scripts/entity_defs/TestNoBase.def
export abstract class TestNoBaseBase extends EntityComponent{
	public baseEntityCall:EntityBaseEntityCall_TestNoBaseBase | null = null;
	public cellEntityCall:EntityCellEntityCall_TestNoBaseBase | null = null;
	...
	public override onGetBase()
	{
		...
		this.baseEntityCall = new EntityBaseEntityCall_TestNoBaseBase(this.entityComponentPropertyID, this.ownerID);
	}

	public override onGetCell()
	{
		this.ownerID = this.owner.id;
		this.cellEntityCall = new EntityCellEntityCall_TestNoBaseBase(this.entityComponentPropertyID, this.ownerID);
	}
	...
	public override onRemoteMethodCall(methodUtype:number, stream:MemoryStream){
		let sm:ScriptModule = EntityDef.moduledefs["TestNoBase"];

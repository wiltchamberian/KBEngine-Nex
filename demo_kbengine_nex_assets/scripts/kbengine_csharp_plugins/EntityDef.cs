...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), property(lastSelCharacter / 2).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(onCreateAvatarResult / 10005).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(onRemoveAvatar / 3).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(onReqAvatarList / 10003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(reqAvatarList / 10001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(reqCreateAvatar / 10002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(reqRemoveAvatar / 1).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(reqRemoveAvatarDBID / 2).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Account), method(selectAvatarGame / 10004).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(HP / 47001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(HP_Max / 47002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(MP / 47003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(MP_Max / 47004).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(component1 / 16).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(component2 / 21).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(component3 / 22).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(forbids / 47005).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(level / 41002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(modelID / 41006).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(modelScale / 41007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(moveSpeed / 11).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(name / 41003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(own_val / 6).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(spaceUType / 41001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(state / 47006).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(subState / 47007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(uid / 41004).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(utype / 41005).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(dialog_addOption / 10101).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(dialog_close / 10104).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(dialog_setText / 10102).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onAddSkill / 12).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onJump / 7).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onRemoveSkill / 13).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(recvDamage / 16).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(dialog / 11003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(jump / 5).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(relive / 4).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(requestPull / 11).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(useTargetSkill / 11001).");
			...
			KBVector3 Test_position_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), property(position / 40000).");
			...
			KBVector3 Test_direction_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), property(direction / 40001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), property(spaceID / 40002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), property(own / 18).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), property(state / 17).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(helloCB / 28).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(say / 27).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(hello / 26).");
			...
			KBVector3 TestNoBase_position_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), property(position / 40000).");
			...
			KBVector3 TestNoBase_direction_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), property(direction / 40001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), property(spaceID / 40002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), property(own / 24).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), property(state / 23).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(helloCB / 30).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(hello / 29).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(HP / 47001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(HP_Max / 47002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(MP / 47003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(MP_Max / 47004).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(entityNO / 51007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(forbids / 47005).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(modelID / 41006).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(modelScale / 41007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(moveSpeed / 32).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(name / 41003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(state / 47006).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(subState / 47007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(uid / 41004).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(utype / 41005).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(recvDamage / 34).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(entityNO / 51007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(modelID / 41006).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(modelScale / 41007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(moveSpeed / 43).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(name / 41003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(uid / 41004).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(utype / 41005).");
			...
			KBVector3 Gate_position_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(position / 40000).");
			...
			KBVector3 Gate_direction_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(direction / 40001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(spaceID / 40002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(entityNO / 51007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(modelID / 41006).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(modelScale / 41007).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(name / 41003).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(uid / 41004).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(Gate), property(utype / 41005).");

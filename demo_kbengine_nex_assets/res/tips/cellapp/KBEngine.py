...
class Entity:
	...
	def onTeleport( self ):
		"""
		如果这个函数在脚本中有实现，在通过baseapp的Entity.teleport调用发生的实体传送中，实体(Real
		entity)被传送之前的时刻此方法会被调用。
	...
	def onWitnessed( self, isWitnessed ):
		...
		bool，实体被观察时为True，实体被停止观察时是False。
...
def createEntity( entityType, spaceID, position, direction, params ):
	...
	string，要创建的实体名称，在res/scripts/entities.xml文件里声明。

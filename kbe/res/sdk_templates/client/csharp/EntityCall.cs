    ...
    public class EntityCall
    {
		...
		*/
		...
		{			
			...
			{
				KBELog.ERROR_MSG(className + "::newCall(" + methodName + "), currserver=!" + KBEngineApp.app.currserver);  
				return null;
			}
			...
			{
				KBELog.ERROR_MSG(className + "::newCall: entity-module(" + className + ") error, can not find from EntityDef.moduledefs");
				return null;
			}

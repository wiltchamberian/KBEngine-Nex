...
#ifndef KBE_ENTITY_TABLE_MONGODB_H
#define KBE_ENTITY_TABLE_MONGODB_H
...
namespace KBEngine {
	...
	*/
	...
	{
	public:
		EntityTableItemMongodb_ENTITYCALL(std::string itemDBType,
			uint32 datalength, uint32 flags) :
			EntityTableItemMongodbBase(itemDBType, datalength, flags)
		{
		}
...
#endif
#endif // KBE_ENTITY_TABLE_MONGODB_H

...
//-------------------------------------------------------------------------------------
ClientSDKCSharp::ClientSDKCSharp():
	ClientSDK(),
	initBody_()
{
}
...
//-------------------------------------------------------------------------------------
std::string ClientSDKCSharp::typeToType(const std::string& type)
{
	if (type == "INT8")
	{
		return "SByte";
...
//-------------------------------------------------------------------------------------
void ClientSDKCSharp::onCreateTypeFileName()
{
	sourcefileName_ = "KBETypes.cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKCSharp::onCreateEntityModuleFileName(const std::string& moduleName)
{
	sourcefileName_ = moduleName + moduleSuffix + ".cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKCSharp::onCreateServerErrorDescrsModuleFileName()
{
	sourcefileName_ = "ServerErrorDescrs.cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKCSharp::onCreateEngineMessagesModuleFileName()
{
	sourcefileName_ = "Messages.cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKCSharp::onCreateDefsCustomTypesModuleFileName()
{
	sourcefileName_ = "CustomDataTypes.cs";
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeServerErrorDescrsModuleBegin()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeServerErrorDescrsModuleErrDescr(int errorID, const std::string& errname, const std::string& errdescr)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeServerErrorDescrsModuleEnd()
{
	sourcefileBody_ += "\n\t\t}\n\n";
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEngineMessagesModuleBegin()
{
	initBody_ = "";
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEngineMessagesModuleMessage(Network::ExposedMessageInfo& messageInfos, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEngineMessagesModuleEnd()
{
	sourcefileBody_ += fmt::format("\tpublic class {}\n\t{{\n", "Messages");
...
//-------------------------------------------------------------------------------------
void ClientSDKCSharp::onCreateEntityDefsModuleFileName()
{
	sourcefileName_ = "EntityDef.cs";
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleBegin()
{
	initBody_ = "";
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleEnd()
{
	sourcefileBody_ += "\t}\n\n\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitScriptBegin()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitScriptEnd()
{
	sourcefileBody_ += "\t\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitDefTypesBegin()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitDefTypesEnd()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitDefType(const DataType* pDataType)
{
...
//-------------------------------------------------------------------------------------
void ClientSDKCSharp::onEntityCallModuleFileName(const std::string& moduleName)
{
	sourcefileName_ = std::string("EntityCall") + moduleName + moduleSuffix + ".cs";
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ = headerBody;
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t}}\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityCallMethodBegin(ScriptDefModule* pScriptDefModule, MethodDescription* pMethodDescription, const char* fillString1, const char* fillString2, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityCallMethodEnd(ScriptDefModule* pScriptDefModule, MethodDescription* pMethodDescription)
{
	sourcefileBody_ += fmt::format("\t\t}}\n\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeBaseEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeBaseEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t}}\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeCellEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
	std::string newModuleName;
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeCellEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t}}\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeCustomDataTypesBegin()
{
	initBody_ = "";
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeCustomDataTypesEnd()
{
	sourcefileBody_ += "\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::createArrayChildClass(DataType* pRootDataType, DataType* pDataType, const std::string& className, const std::string& tabs, int numLayer)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeCustomDataType(const DataType* pDataType)
{
	uint16 typeID = datatype2id(pDataType->getName());
	if (typeID == 0 || strcmp(pDataType->getName(), "FIXED_DICT") == 0 || strcmp(pDataType->getName(), "ARRAY") == 0)
	{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitScript_ScriptModule(ScriptDefModule* pScriptDefModule)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitScript_MethodDescr(ScriptDefModule* pScriptDefModule, MethodDescription* pDescr, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityDefsModuleInitScript_PropertyDescr(ScriptDefModule* pScriptDefModule, PropertyDescription* pDescr)
{
	...
	else
	{
		...
		if (readName == "KBVector2" || readName == "KBVector3" || readName == "KBVector4")
		{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypesBegin()
{
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypesEnd()
{
	sourcefileBody_ += "\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeBegin(std::string typeName, FixedDictType* pDataType)
{
	sourcefileBody_ += fmt::format("\tpublic class {}\n\t{{\n", typeName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeEnd(std::string typeName, FixedDictType* pDataType)
{
	sourcefileBody_ += "\n\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeBegin(std::string typeName, FixedArrayType* pDataType, const std::string& parentClass)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeEnd(std::string typeName, FixedArrayType* pDataType)
{
	sourcefileBody_ += "\n\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeBegin(std::string typeName, DataType* pDataType)
{
	sourcefileBody_ += fmt::format("\tpublic struct {}\n\t{{\n", typeName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeEnd(std::string typeName, DataType* pDataType)
{
	sourcefileBody_ += "\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_AliasName(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_INT8(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_INT16(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_INT32(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_INT64(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_UINT8(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_UINT16(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_UINT32(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_UINT64(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_FLOAT(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_DOUBLE(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_STRING(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_UNICODE(const std::string& itemName, const std::string& childItemName)
{
	sourcefileBody_ += fmt::format("\t\tpublic string {} = \"\";\n", itemName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_PYTHON(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_PY_DICT(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_PY_TUPLE(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_PY_LIST(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_BLOB(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_ARRAY(const std::string& itemName, const std::string& childItemName, DataType* pDataType)
{
	std::string typeStr;
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_FIXED_DICT(const std::string& itemName, const std::string& childItemName, DataType* pDataType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_VECTOR2(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
	sourcefileBody_ += fmt::format("\t\tpublic KBVector2Int {} = new KBVector2Int(0, 0);\n", itemName);
#else
	sourcefileBody_ += fmt::format("\t\tpublic KBVector2 {} = new KBVector2(0f, 0f);\n", itemName);
#endif
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_VECTOR3(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
	sourcefileBody_ += fmt::format("\t\tpublic KBVector3Int {} = new KBVector3Int(0, 0, 0);\n", itemName);
#else
	sourcefileBody_ += fmt::format("\t\tpublic KBVector3 {} = new KBVector3(0f, 0f, 0f);\n", itemName);
#endif
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_VECTOR4(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
	sourcefileBody_ += fmt::format("\t\tpublic KBVector4Int {} = new KBVector4Int(0, 0, 0, 0);\n", itemName);
#else
	sourcefileBody_ += fmt::format("\t\tpublic KBVector4 {} = new KBVector4(0f, 0f, 0f, 0f);\n", itemName);
#endif
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeTypeItemType_ENTITYCALL(const std::string& itemName, const std::string& childItemName)
{
	sourcefileBody_ += fmt::format("\t\tpublic byte[] {} = new byte[0];\n", itemName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityModuleBegin(ScriptDefModule* pEntityScriptDefModule)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityModuleEnd(ScriptDefModule* pEntityScriptDefModule)
{
	sourcefileBody_ += "\t}\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::getArrayType(DataType* pDataType, std::string& outstr)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProcessMessagesMethod(ScriptDefModule* pEntityScriptDefModule)
{
	std::string ownstr = "";
	if (pEntityScriptDefModule->isComponentModule())
		ownstr = "owner.";
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityPropertyComponent(ScriptDefModule* pEntityScriptDefModule,
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_INT8(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_INT16(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_INT32(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_INT64(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_UINT8(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_UINT16(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_UINT32(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_UINT64(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_FLOAT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_DOUBLE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_STRING(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ += fmt::format("\t\tpublic string {} = \"{}\";\n", pPropertyDescription->getName(),
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_UNICODE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ += fmt::format("\t\tpublic string {} = \"{}\";\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : ""));
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_PYTHON(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKCSharp::writeEntityProperty_PYTHON(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_PY_DICT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKCSharp::writeEntityProperty_PY_DICT(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_PY_TUPLE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKCSharp::writeEntityProperty_PY_TUPLE(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_PY_LIST(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKCSharp::writeEntityProperty_PY_LIST(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_BLOB(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ += fmt::format("\t\tpublic byte[] {} = {};\n", pPropertyDescription->getName(),
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_ARRAY(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_FIXED_DICT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ += fmt::format("\t\tpublic {} {} = new {}();\n", pPropertyDescription->getDataTypeName(), pPropertyDescription->getName(),
		pPropertyDescription->getDataTypeName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_VECTOR2(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
	sourcefileBody_ += fmt::format("\t\tpublic KBVector2Int {} = {};\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : "new KBVector2Int(0, 0)"));

	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	sourcefileBody_ += fmt::format("\t\tpublic virtual void on{}Changed(KBVector2Int oldValue) {{}}\n", name);
#else
	sourcefileBody_ += fmt::format("\t\tpublic KBVector2 {} = {};\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : "new KBVector2(0f, 0f)"));

	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	sourcefileBody_ += fmt::format("\t\tpublic virtual void on{}Changed(KBVector2 oldValue) {{}}\n", name);
#endif
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_VECTOR3(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
	sourcefileBody_ += fmt::format("\t\tpublic KBVector3Int {} = {};\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : "new KBVector3Int(0, 0, 0)"));

	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	sourcefileBody_ += fmt::format("\t\tpublic virtual void on{}Changed(KBVector3Int oldValue) {{}}\n", name);
#else
	sourcefileBody_ += fmt::format("\t\tpublic KBVector3 {} = {};\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : "new KBVector3(0f, 0f, 0f)"));

	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	sourcefileBody_ += fmt::format("\t\tpublic virtual void on{}Changed(KBVector3 oldValue) {{}}\n", name);
#endif
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_VECTOR4(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
	sourcefileBody_ += fmt::format("\t\tpublic KBVector4Int {} = {};\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : "new KBVector4Int(0, 0, 0, 0)"));

	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	sourcefileBody_ += fmt::format("\t\tpublic virtual void on{}Changed(KBVector4Int oldValue) {{}}\n", name);
#else
	sourcefileBody_ += fmt::format("\t\tpublic KBVector4 {} = {};\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : "new KBVector4(0f, 0f, 0f, 0f)"));

	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	sourcefileBody_ += fmt::format("\t\tpublic virtual void on{}Changed(KBVector4 oldValue) {{}}\n", name);
#endif
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityProperty_ENTITYCALL(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ += fmt::format("\t\tpublic byte[] {} = {};\n", pPropertyDescription->getName(),
		(strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : "new byte[0]"));
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityMethod(ScriptDefModule* pEntityScriptDefModule,
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityMethodArgs_ARRAY(FixedArrayType* pFixedArrayType, std::string& stackArgsTypeBody, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKCSharp::writeEntityMethodArgs_Const_Ref(DataType* pDataType, std::string& stackArgsTypeBody)
{
	return true;
}
